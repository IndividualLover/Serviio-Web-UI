...
<script src="tree/jqueryFileTree/jqueryFileTree.js" type="text/javascript"></script>
	...
	if (pageurl.indexOf("content.php?tab=logs")!=-1) {
	 $("#addFolder2").click(function(e) {
			 ...
			 $("#dialog-form2").dialog({
                ...
                modal: true,
                buttons: {
                    "<?php echo tr('button_select_folder','Select File')?>": function() {
                        var tmp = $(".sel2").attr('href');
                        $("#location").val(tmp);
			 ...
			 $("#smallbrowser2").fileTree({
                script: 'tree/jqueryFileTree/connectors/jqueryFileTree.php',
				expandSpeed: 1000,
				collapseSpeed: 1000,
				multiFolder: true
				}, function(file) {
...
Maintained by 2013  <a href="https://github.com/IndividualLover/Web-UI-for-Serviio">Individual</a><br>
